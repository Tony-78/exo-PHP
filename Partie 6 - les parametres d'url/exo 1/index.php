<?php
$lastname = "Paramètre non renseigné";
$firstname ="Paramètre non renseigné";
...
index.php?lastname=Tutor&firstname=Janine<br><br>
...
<a class="btn btn-primary" href="index.php?lastname=Tutor&amp;firstname=Janine">Envoi des paramètres</a>
<a class="btn btn-secondary" href="index.php">Retour Index</a>
<p>Paramètre 1 : <?php echo $lastname ?></p>
<p>Paramètre 2 : <?php echo $firstname ?></p>
